...
let ExpressServer = class ExpressServer {
    constructor() {
        ...
        this.conformExpressControllerToSeatbeltController = function (route, req, res, next) {
            route.controller({
                next,
                ...
                routes.forEach((route) => {
                    route['__seatbelt_config__'].type.forEach((eachType) => {
                        route['__seatbelt_config__'].path.forEach((eachPath) => {
                            this.server[eachType.toLowerCase()](eachPath, (req, res, next) => this.conformExpressControllerToSeatbeltController(route, req, res, next));
                        });
                    });
                });
            }
...
exports.server = new ExpressServer();
